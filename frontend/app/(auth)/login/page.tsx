...
import { Music, Mail, Lock, LogIn, ArrowLeft, Info } from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: "20px" }}>
      ...
      >
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "0.9rem" }}>SwarLipi AI Instrumentation Portal</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: "24px", color: "var(--text-muted)", fontSize: "0.9rem" }}>
          Don't have instrumentation access? <Link href="/signup" style={{ color: "var(--color-aurora-bright)", fontWeight: 700 }}>Sign Up</Link>
        </p>
      </motion.div>
    </div>
  );
